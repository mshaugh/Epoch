...
const timezones: Timezone[] = Object.values(ct.getAllTimezones()).map(tz => {
...
const datetimeFormats: { [style: string]: { options?: Intl.DateTimeFormatOptions, format?: (epoch: Dayjs) => string } } = {
    "t": {
    ...
    "F": {
        options: { weekday: 'long', year: 'numeric', month: 'long', day: '2-digit', hour: '2-digit', minute: '2-digit' },
    },
    "R": {
